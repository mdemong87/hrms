...
const MultiSelect = ({ label, options, selectedOptions, setSelectedOptions, disabled = false, error = false }) => {
  ...
  /****** selectable value toggler function here *****/
  ...
  /********* remove from seleted data function here *********/
