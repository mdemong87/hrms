                    ...
                    <>
                        <div className="lg:col-span-3 space-y-4">
                                    ...
                                    <div className="flex items-center justify-between w-full">
                                        <div>
                                            ...
                                            <div className="flex items-center gap-2">
                                                <h2 className="text-3xl font-semibold">{singleProject?.name}</h2>
                                            ...
                                            <div className="flex items-center gap-2 mt-3">
                                                ...
                                                <span className="font-semibold">Sales By:</span>{" "} <span className="font-normal">{
                                                    singleProject?.taken_by?.[0] && singleProject?.taken_by[0]?.fname + " " + singleProject?.taken_by[0]?.lname}</span>
                                        ...
                                        <div className="flex flex-col gap-0 items-end">
                                            <div className="flex items-center gap-2">
                                                ...
                                                {(accessRole === "Admin" || accessRole === "Project Manager") && (
                                                    ...
                                                    (singleProject?.status != "Delivered" && singleProject?.status != "Cancelled") && (
                            ...
                            <div className="rounded-xl p-5 shadow-md bg-white">
                                ...
                                <div className="text-sm text-gray-900 whitespace-pre-line z-10">
                        ...
                        <div className="space-y-4">
                            <div className="rounded-xl p-4 px-4 shadow-md bg-white dark:bg-slate-800 sticky top-20">
                                ...
                                <div className="space-y-3">
                                    {singleProject?.employees?.map((member, idx) => (
                                        <div key={idx} className="flex items-center justify-between">
                                            ...
                                            <div className="bg-green-100 dark:bg-green-300 border border-green-200 text-sm px-1 py-0 rounded-md text-gray-800">
                                                ${member?.destribution}
                                            </div>
                                        </div>
                                    ))}
