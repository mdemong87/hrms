...
const navItems: NavItem[] = [
  ...
  },
  {
    icon: <TableIcon />,
    name: "Employees",
    subItems: [{ name: "Attendance", path: "/admin/employee/attendance", pro: false }, { name: "ALL Employee", path: "/admin/employee", pro: false }, { name: "Add Employee", path: "/admin/employee/add", pro: false }],
  },
  {
