...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    name: "Task/Project",
    subItems: [{ name: "All Project", path: "/admin/projects", pro: false }, { name: "Active Project", path: "/admin/projects/activeproject", pro: false }, { name: "Cancel Project", path: "/admin/projects/cancelproject" }, { name: "Unassign Employee", path: "/admin/projects/unassignemployee" }, { name: "Add Project", path: "/admin/projects/addproject" }],
  },
  {
